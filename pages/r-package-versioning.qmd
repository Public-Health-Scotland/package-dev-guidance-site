...
If the answer is yes, this should be a major release. (You should also consider using [lifecycle](https://lifecycle.r-lib.org/articles/communicate.html) to manage and communicate these breaking changes).
